...
docker run -d -p $PORT1:4567 -p $PORT2:5244 -e ALIST_PORT=$PORT2 --restart=always -v "$BASE_DIR":/config/alist-tvbox ${MOUNT} --name=alist-tvbox haroldli/alist-tvbox:${TAG}
