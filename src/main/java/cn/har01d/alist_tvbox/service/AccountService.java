...
public class AccountService {
    ...
    private String readRefreshToken() {
        Path path = Paths.get("/config/alist-tvbox/mytoken.txt");
    ...
    private String readOpenToken() {
        Path path = Paths.get("/config/alist-tvbox/myopentoken.txt");
        if (Files.exists(path)) {
            try {
    ...
    private void readLogin() {
        try {
            ...
            Path pass = Paths.get("/config/alist-tvbox/guestpass.txt");
            ...
            Path guest = Paths.get("/config/alist-tvbox/guestlogin.txt");
